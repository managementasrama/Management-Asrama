        ...
        <form onSubmit={handleSave} className="p-5 space-y-4 overflow-y-auto custom-scrollbar flex-1 text-xs">
          ...
          {isSuperAdmin(currentUser.role) && (
            <div className="pt-4 border-t border-slate-200 space-y-3.5">
              ...
              <div>
                <label className="block font-bold text-slate-700 mb-1">Judul Web Sistem (Header)</label>
                <input
                  type="text"
                  value={webTitle}
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full p-2.5 bg-slate-50 border border-slate-300 rounded-xl font-medium focus:ring-2 focus:ring-hajj-600 focus:outline-none text-xs"
                >
          ...
          <div className="pt-3 flex items-center justify-end space-x-2.5 border-t border-slate-200">
            ...
            <button
              type="submit"
              className="px-5 py-2 bg-hajj-700 hover:bg-hajj-800 text-white font-bold rounded-xl shadow-md transition flex items-center space-x-1.5"
            >
